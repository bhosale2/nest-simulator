...
{
public:
	PositionVerlet2nd(Vrodptr& _rodptrs, Vefptr& _efptrs, Vbcptr& _bcptrs, Vinterptr& _interptrs, Vecptr& _ecptrs) : PolymerIntegrator(_rodptrs, _efptrs, _bcptrs, _interptrs, _ecptrs){};
